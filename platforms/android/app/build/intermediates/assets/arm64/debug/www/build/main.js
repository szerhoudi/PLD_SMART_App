...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_rest__ = __webpack_require__(46);
...
var RealMapPage = (function () {
    ...
    RealMapPage.prototype.ionViewDidEnter = function () {
        this.changeDetectorRef.reattach();
        this.changeDetectorRef.detectChanges();
        this.checkViewStatus = true;
        console.log("ionViewDidEnter");
    };
    RealMapPage.prototype.ionViewWillLeave = function () {
        this.changeDetectorRef.detach();
        this.checkViewStatus = false;
        console.log("ionViewWillLeave");
    };
    RealMapPage.prototype.ionViewDidLeave = function () {
        this.changeDetectorRef.detach();
        this.checkViewStatus = false;
        console.log("ionViewDidLeave");
    };
    RealMapPage.prototype.ionViewWillUnload = function () {
        this.changeDetectorRef.detach();
        this.checkViewStatus = false;
    ...
    RealMapPage.prototype.drawPathMinor = function (minorValue) {
        // draw a line path from A to B.
        this.minorb = this.beaconDetector.minorb;
        var pointA = this.minorb;
        console.log(pointA + "  " + minorValue);
        var beaconsPoints = this.graph.findShortestPath(pointA, minorValue);
        this.pathPoints = "";
        var i;
        for (i = 0; i < beaconsPoints.length; i++) {
            var b = beaconsPoints[i];
    ...
    RealMapPage.prototype.fetchData = function () {
        ...
        this.restProvider.fetchData()
            ...
            for (var i = 0, l = Object.keys(_this.dataJson.connectors).length; i < l; i++) {
                _this.points[_this.dataJson.connectors[i].id] = _this.dataJson.connectors[i];
            }
            console.log(data);
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__activities_detail_activities_detail__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__real_map_real_map__ = __webpack_require__(112);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_settings__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_rest__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_beacon_detector__ = __webpack_require__(58);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LocalisationPage = (function () {
    function LocalisationPage(navCtrl, navParams, changeDetectorRef, settings, beaconDetector, restProvider, http, events, storage) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.changeDetectorRef = changeDetectorRef;
        ...
        this.handleBeaconStatusChanged = function (beacons) {
                ...
                if (isWithinRange && isWithinAgeLimit) {
                    for (var i in _this.standJson) {
                        ...
                        if (idBeacon == beacon.minor) {
                            ...
                            beacon.id = _this.standJson[i].id;
                        }
                    }
                    displayableBeacons.push(beacon);
                }
            ...
            if (_this.checkViewStatus) {
                setTimeout(function () { _this.changeDetectorRef.detectChanges(); }, 1000);
            }
        };
        beaconDetector.addBeaconStatusChangedHandler(this.handleBeaconStatusChanged);
        this.fetchData();
        ...
        this.storage.get('oldUrl').then(function (val) {
            ...
            _this.storage.get('url').then(function (val) {
                ...
                _this.http.get(_this.url).map(function (res) { return res.json(); }).subscribe(function (data) {
                    _this.posts = data;
                    var taille = _this.posts.activitesBalise.length;
                    _this.storage.get('favorites').then(function (val) {
                        for (var i = 0; i < taille; i++) {
                            _this.listFavoris.push(false);
                        }
                        val.forEach(function (idfav) {
                            _this.listFavoris.splice(idfav, 1, true);
                        });
                    });
                });
            });
    ...
    LocalisationPage.prototype.showDetailPage = function (beacon) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_2__activities_detail_activities_detail__["a" /* ActivitiesDetailPage */], {
            id: beacon.id
        });
    };
    LocalisationPage.prototype.showPath = function (beaconParam) {
        this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_3__real_map_real_map__["a" /* RealMapPage */], {
            minor: beaconParam.minor
        });
    };
    LocalisationPage.prototype.ionViewDidEnter = function () {
        this.changeDetectorRef.reattach();
        this.changeDetectorRef.detectChanges();
        this.checkViewStatus = true;
        console.log("ionViewDidEnter");
    };
    LocalisationPage.prototype.ionViewWillLeave = function () {
        this.changeDetectorRef.detach();
        this.checkViewStatus = false;
        console.log("ionViewWillLeave");
    };
    LocalisationPage.prototype.ionViewDidLeave = function () {
        this.changeDetectorRef.detach();
        this.checkViewStatus = false;
        console.log("ionViewDidLeave");
    };
    LocalisationPage.prototype.ionViewWillUnload = function () {
        this.changeDetectorRef.detach();
        this.checkViewStatus = false;
        console.log("ionViewWillUnload");
    };
    LocalisationPage.prototype.changeFavorite = function (beacon) {
        var _this = this;
        var ajouterFav = true;
        var favorites = [];
        var listMinors = [];
        this.storage.get('favorites').then(function (val) {
            favorites = val;
            console.log('val :', val);
            val.forEach(function (idfav, index) {
                if (idfav == beacon.id) {
                    ajouterFav = false;
                    favorites.splice(index, 1);
                    _this.listFavoris.splice(beacon.id, 1, false);
                }
            });
            if (ajouterFav == true) {
                favorites.push(beacon.id);
                _this.listFavoris.splice(beacon.id, 1, true);
            }
            _this.storage.set('favorites', favorites);
            _this.dataFav.activitesBalise.forEach(function (event) {
                if (favorites != null) {
    ...
    LocalisationPage.prototype.fetchEvent = function () {
        var _this = this;
    ...
    LocalisationPage = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* NavParams */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["j" /* ChangeDetectorRef */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["j" /* ChangeDetectorRef */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_6__providers_settings__["a" /* Settings */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__providers_settings__["a" /* Settings */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_8__providers_beacon_detector__["a" /* BeaconDetector */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_8__providers_beacon_detector__["a" /* BeaconDetector */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_7__providers_rest__["a" /* Rest */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_7__providers_rest__["a" /* Rest */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_4__angular_http__["a" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__angular_http__["a" /* Http */]) === "function" && _g || Object, typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */]) === "function" && _h || Object, typeof (_j = typeof __WEBPACK_IMPORTED_MODULE_5__ionic_storage__["b" /* Storage */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__ionic_storage__["b" /* Storage */]) === "function" && _j || Object])
    ], LocalisationPage);
...
var ActivitiesPage = (function () {
    function ActivitiesPage(navCtrl, events, navParams, http, storage, restProvider) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.events = events;
        this.navParams = navParams;
        ...
        this.storage.get('favorites').then(function (val) {
            ...
            val.forEach(function (idfav, index) {
                if (idfav == activity.id) {
                    ajouterFav = false;
                    favorites.splice(index, 1);
                    _this.listFavoris.splice(activity.id, 1, false);
                }
            });
            if (ajouterFav == true) {
                favorites.push(activity.id);
                _this.listFavoris.splice(activity.id, 1, true);
            }
            _this.storage.set('favorites', favorites);
            _this.dataFav.activitesBalise.forEach(function (event) {
                if (favorites != null) {
    ...
    ActivitiesPage.prototype.fetchEvent = function () {
        var _this = this;
        this.restProvider.fetchEvent()
            .then(function (data) {
            _this.dataFav = data;
    ...
    ActivitiesPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* NavParams */], __WEBPACK_IMPORTED_MODULE_3__angular_http__["a" /* Http */], __WEBPACK_IMPORTED_MODULE_4__ionic_storage__["b" /* Storage */], __WEBPACK_IMPORTED_MODULE_5__providers_rest__["a" /* Rest */]])
    ], ActivitiesPage);
...
var ChangeEventPage = (function () {
    function ChangeEventPage(alerCtrl, navCtrl, navParams, http, storage, events) {
        var _this = this;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function () {
                        ...
                        _this.events.publish('event:changed', _this.posts.Event[id].nom);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_user_data__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__tabs_page_tabs_page__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__signup_signup__ = __webpack_require__(117);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_localisation_localisation__ = __webpack_require__(215);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_activities_activities__ = __webpack_require__(218);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_activities_detail_activities_detail__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_real_map_real_map__ = __webpack_require__(112);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_map_map__ = __webpack_require__(113);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__pages_schedule_schedule__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__pages_schedule_filter_schedule_filter__ = __webpack_require__(223);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__pages_session_detail_session_detail__ = __webpack_require__(115);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__pages_signup_signup__ = __webpack_require__(117);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__pages_speaker_detail_speaker_detail__ = __webpack_require__(224);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__pages_speaker_list_speaker_list__ = __webpack_require__(116);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__pages_tabs_page_tabs_page__ = __webpack_require__(47);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__providers_rest__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__providers_beacon_detector__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__providers_location_manager__ = __webpack_require__(216);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__pages_event_modal_event_modal__ = __webpack_require__(217);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_splash_screen__ = __webpack_require__(213);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_http__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_map__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_map__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_storage__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_localisation_localisation__ = __webpack_require__(215);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_activities_activities__ = __webpack_require__(218);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_real_map_real_map__ = __webpack_require__(112);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_map_map__ = __webpack_require__(113);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_signup_signup__ = __webpack_require__(117);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_tabs_page_tabs_page__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__pages_tutorial_tutorial__ = __webpack_require__(225);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_schedule_schedule__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__pages_speaker_list_speaker_list__ = __webpack_require__(116);
...
this.platformReady()
    ...
    ConferenceApp.prototype.listenToChangesEvents = function () {
        var _this = this;
        this.events.subscribe('event:changed', function (title) {
            _this.title = title;
        });
    };
    ...
    ConferenceApp = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */],
            ...
            __WEBPACK_IMPORTED_MODULE_24__providers_settings__["a" /* Settings */],
            __WEBPACK_IMPORTED_MODULE_25__providers_beacon_detector__["a" /* BeaconDetector */]])
    ], ConferenceApp);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_map__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_map__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_kalmanjs__ = __webpack_require__(304);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_kalmanjs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_kalmanjs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__location_manager__ = __webpack_require__(216);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__rest__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__settings__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_event_modal_event_modal__ = __webpack_require__(217);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BeaconDetector = (function () {
    function BeaconDetector(locationManager, restProvider, http, modalCtrl, events, sets, storage) {
        ...
        this.didRangeBeaconsInRegionHandler = function (result) {
            ...
            var beaconSignals = [];
            var rssiValues = {};
            var kalmanFilter = new __WEBPACK_IMPORTED_MODULE_5_kalmanjs___default.a({ R: 0.01, Q: 20 });
            for (var _i = 0, _a = result.beacons; _i < _a.length; _i++) {
                var beacon = _a[_i];
                beacon.accuracy = _this.calculateAccuracy(kalmanFilter.filter(beacon.rssi), beacon.tx);
            ...
            _this.events.subscribe('favorites:created', function (favorites) {
                _this.listFavorites = favorites;
            });
    ...
    BeaconDetector.prototype.showConfirm = function (msg, url) {
        ...
        var eventModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_9__pages_event_modal_event_modal__["a" /* EventModalPage */], obj);
    ...
    BeaconDetector.prototype.showAlerts = function (eventData) {
        ...
        var eventModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_9__pages_event_modal_event_modal__["a" /* EventModalPage */], data);
        eventModal.present();
    };
    ...
    BeaconDetector = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["A" /* Injectable */])(),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_6__location_manager__["a" /* LocationManager */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__location_manager__["a" /* LocationManager */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_7__rest__["a" /* Rest */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_7__rest__["a" /* Rest */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Http */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* ModalController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* ModalController */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_8__settings__["a" /* Settings */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_8__settings__["a" /* Settings */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_3__ionic_storage__["b" /* Storage */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__ionic_storage__["b" /* Storage */]) === "function" && _g || Object])
    ], BeaconDetector);
